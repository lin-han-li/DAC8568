...
void MX_LTDC_Init(void) {
  ...
  hltdc.Init.AccumulatedActiveW = 360;
  hltdc.Init.AccumulatedActiveH = 260;
  hltdc.Init.TotalWidth = 400;
  hltdc.Init.TotalHeigh = 270;
  ...
  if (ltdcHandle->Instance == LTDC) {
    ...
    */
    ...
    GPIO_InitStruct.Pin = GPIO_PIN_15 | GPIO_PIN_14 | GPIO_PIN_12 |
                          GPIO_PIN_13 | GPIO_PIN_11 | GPIO_PIN_10 | GPIO_PIN_9 |
...
void HAL_LTDC_MspDeInit(LTDC_HandleTypeDef *ltdcHandle) {
  ...
  if (ltdcHandle->Instance == LTDC) {
    ...
    */
    ...
    HAL_GPIO_DeInit(GPIOJ,
                    GPIO_PIN_15 | GPIO_PIN_14 | GPIO_PIN_12 | GPIO_PIN_13 |
