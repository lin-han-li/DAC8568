...
void HAL_SPI_MspInit(SPI_HandleTypeDef* spiHandle)
{
  ...
  */
    ...
    PeriphClkInitStruct.PLL2.PLL2N = 132;
    ...
    PA4     ------> SPI1_NSS
    */
    GPIO_InitStruct.Pin = DAC8568_DIN_Pin|DAC85_CLK_Pin;
  ...
  */
  ...
  /* USER CODE BEGIN SPI6_MspInit 1 */
    /* Keep SPI6 pins at very high speed for high SPI clock. */
    GPIO_InitStruct.Pin = GPIO_PIN_15;
    GPIO_InitStruct.Mode = GPIO_MODE_AF_PP;
    GPIO_InitStruct.Pull = GPIO_NOPULL;
    GPIO_InitStruct.Speed = GPIO_SPEED_FREQ_VERY_HIGH;
...
void HAL_SPI_MspDeInit(SPI_HandleTypeDef* spiHandle)
{
  ...
  /* USER CODE END SPI1_MspDeInit 0 */
    ...
    PA4     ------> SPI1_NSS
    */
    HAL_GPIO_DeInit(GPIOA, DAC8568_DIN_Pin|DAC85_CLK_Pin|DAC8568_SYNC_Pin);
