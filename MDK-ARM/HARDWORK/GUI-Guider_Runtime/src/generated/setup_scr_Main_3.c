...
void setup_scr_Main_3(lv_ui *ui) {
  ...
  lv_obj_set_size(ui->Main_3, 320, 240);
  ...
  lv_obj_set_style_bg_grad_color(ui->Main_3, lv_color_hex(0x1e293b),
                                 LV_PART_MAIN);
  ...
  lv_obj_set_size(ui->Main_3_header, 320, 30);
  lv_obj_set_pos(ui->Main_3_header, 0, 0);
  lv_obj_set_style_bg_color(ui->Main_3_header, lv_color_hex(0x000000),
                            LV_PART_MAIN);
  ...
  lv_obj_set_style_text_color(ui->Main_3_title, lv_color_hex(0x38BDF8),
                              LV_PART_MAIN);
  lv_obj_set_style_text_font(ui->Main_3_title, gui_assets_get_font_16(),
                             LV_PART_MAIN);
  lv_obj_align(ui->Main_3_title, LV_ALIGN_LEFT_MID, 8, 0);

  ui->Main_3_status = lv_label_create(ui->Main_3_header);
  lv_label_set_text(ui->Main_3_status, "WiFi: ON");
  lv_obj_set_style_text_color(ui->Main_3_status, lv_color_hex(0x94A3B8),
                              LV_PART_MAIN);
  lv_obj_set_style_text_font(ui->Main_3_status, gui_assets_get_font_12(),
                             LV_PART_MAIN);
  lv_obj_align(ui->Main_3_status, LV_ALIGN_RIGHT_MID, -8, 0);

  ui->Main_3_cont_grid = lv_obj_create(ui->Main_3);
  lv_obj_set_size(ui->Main_3_cont_grid, 300, 170);
  lv_obj_align(ui->Main_3_cont_grid, LV_ALIGN_CENTER, 0, 5);
  ...
  create_tile(ui->Main_3_cont_grid, &ui->Main_3_tile_1, &ui->Main_3_img_1,
              &ui->Main_3_lbl_1, "Q:/gui/icon_13_fwup_RGB565A8_100x100.bin",
              "固件升级", 0, 0);
  create_tile(ui->Main_3_cont_grid, &ui->Main_3_tile_2, &ui->Main_3_img_2,
              &ui->Main_3_lbl_2, "Q:/gui/icon_14_about_RGB565A8_100x100.bin",
              "关于系统", 1, 0);

  ui->Main_3_footer = lv_obj_create(ui->Main_3);
  lv_obj_set_size(ui->Main_3_footer, 100, 20);
  lv_obj_align(ui->Main_3_footer, LV_ALIGN_BOTTOM_MID, 0, -4);
  ...
  lv_obj_set_flex_align(ui->Main_3_footer, LV_FLEX_ALIGN_CENTER,
                        LV_FLEX_ALIGN_CENTER, LV_FLEX_ALIGN_CENTER);
  lv_obj_set_style_pad_gap(ui->Main_3_footer, 8, LV_PART_MAIN);
  ...
  lv_obj_set_size(ui->Main_3_dot_1, 6, 6);
  lv_obj_set_style_bg_color(ui->Main_3_dot_1, lv_color_hex(0xFFFFFF),
                            LV_PART_MAIN);
  lv_obj_set_style_bg_opa(ui->Main_3_dot_1, 50, LV_PART_MAIN);
  lv_obj_set_style_radius(ui->Main_3_dot_1, 3, LV_PART_MAIN);
  lv_obj_add_flag(ui->Main_3_dot_1, LV_OBJ_FLAG_CLICKABLE);

  ui->Main_3_dot_2 = lv_obj_create(ui->Main_3_footer);
  lv_obj_set_size(ui->Main_3_dot_2, 6, 6);
  lv_obj_set_style_bg_color(ui->Main_3_dot_2, lv_color_hex(0xFFFFFF),
                            LV_PART_MAIN);
  lv_obj_set_style_bg_opa(ui->Main_3_dot_2, 50, LV_PART_MAIN);
  lv_obj_set_style_radius(ui->Main_3_dot_2, 3, LV_PART_MAIN);
  lv_obj_add_flag(ui->Main_3_dot_2, LV_OBJ_FLAG_CLICKABLE);

  ui->Main_3_dot_3 = lv_obj_create(ui->Main_3_footer);
  lv_obj_set_size(ui->Main_3_dot_3, 16, 6);
  lv_obj_set_style_bg_color(ui->Main_3_dot_3, lv_color_hex(0x38BDF8),
                            LV_PART_MAIN);
  lv_obj_set_style_radius(ui->Main_3_dot_3, 3, LV_PART_MAIN);
