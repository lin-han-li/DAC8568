...
static void create_step_row(lv_obj_t *parent, int32_t y_offset,
  ...
  *led_ptr = lv_led_create(parent);
  ...
  lv_led_set_color(*led_ptr, lv_color_hex(0x64748B));
  lv_led_off(*led_ptr);
  ...
  *btn_ptr = lv_button_create(parent);
  ...
  lv_obj_set_style_bg_color(*btn_ptr, lv_color_hex(0x0EA5E9), LV_PART_MAIN);
  ...
  *btn_lbl_ptr = lv_label_create(*btn_ptr);
  ...
  if (y_offset < (PANEL_PAD_TOP + STEP_ROW_HEIGHT * 3)) {
    ...
    lv_obj_set_style_bg_color(line, lv_color_hex(0x334155), LV_PART_MAIN);
...
void setup_scr_DeviceConnect(lv_ui *ui) {
  ...
  lv_obj_set_style_bg_color(ui->DeviceConnect, lv_color_hex(0x0f172a),
                            LV_PART_MAIN);
  lv_obj_set_style_bg_opa(ui->DeviceConnect, 255, LV_PART_MAIN);
  lv_obj_set_style_bg_grad_dir(ui->DeviceConnect, LV_GRAD_DIR_VER,
                               LV_PART_MAIN);
  lv_obj_set_style_bg_grad_color(ui->DeviceConnect, lv_color_hex(0x1e293b),
                                 LV_PART_MAIN);
  ...
  lv_obj_set_style_bg_opa(header, 80, LV_PART_MAIN);
  ...
  lv_obj_set_style_text_color(ui->DeviceConnect_lbl_title,
                              lv_color_hex(0x38BDF8), LV_PART_MAIN);
  ...
  lv_obj_set_style_border_color(ui->DeviceConnect_btn_autorec,
                                lv_color_hex(0x475569), LV_PART_MAIN);
  ...
  lv_obj_set_style_bg_opa(ui->DeviceConnect_cont_panel, 15, LV_PART_MAIN);
  lv_obj_set_style_radius(ui->DeviceConnect_cont_panel, 12, LV_PART_MAIN);
  lv_obj_set_style_border_width(ui->DeviceConnect_cont_panel, 1, LV_PART_MAIN);
  lv_obj_set_style_border_color(ui->DeviceConnect_cont_panel,
                                lv_color_hex(0xFFFFFF), LV_PART_MAIN);
  lv_obj_set_style_border_opa(ui->DeviceConnect_cont_panel, 30, LV_PART_MAIN);
  ...
  lv_obj_set_style_bg_color(ui->DeviceConnect_btn_back, lv_color_hex(0x334155),
                            LV_PART_MAIN);
  ...
  lv_obj_set_style_bg_opa(ui->DeviceConnect_ta_console, 180, LV_PART_MAIN);
  ...
  lv_obj_set_style_bg_color(ui->DeviceConnect_btn_auto, lv_color_hex(0x0EA5E9),
                            LV_PART_MAIN);
