...
static void create_tile(lv_obj_t *parent, lv_obj_t **tile_ptr,
                        lv_obj_t **img_ptr, lv_obj_t **lbl_ptr,
                        const char *icon_path, const char *label_text,
                        int32_t col, int32_t row) {
  *tile_ptr = lv_obj_create(parent);
  lv_obj_set_size(*tile_ptr, 88, 75);
  ...
  *lbl_ptr = lv_label_create(*tile_ptr);
  ...
  lv_obj_set_style_text_font(*lbl_ptr, gui_assets_get_font_12(), LV_PART_MAIN);
...
void setup_scr_Main_1(lv_ui *ui) {
  ...
  lv_obj_set_size(ui->Main_1, 320, 240);
  ...
  lv_obj_set_style_bg_grad_color(ui->Main_1, lv_color_hex(0x1e293b),
                                 LV_PART_MAIN);
  ...
  lv_obj_set_size(ui->Main_1_header, 320, 30);
  lv_obj_set_pos(ui->Main_1_header, 0, 0);
  lv_obj_set_style_bg_color(ui->Main_1_header, lv_color_hex(0x000000),
                            LV_PART_MAIN);
  ...
  lv_obj_set_style_text_color(ui->Main_1_title, lv_color_hex(0x38BDF8),
                              LV_PART_MAIN);
  lv_obj_set_style_text_font(ui->Main_1_title, gui_assets_get_font_16(),
                             LV_PART_MAIN);
  lv_obj_align(ui->Main_1_title, LV_ALIGN_LEFT_MID, 8, 0);

  ui->Main_1_status = lv_label_create(ui->Main_1_header);
  lv_label_set_text(ui->Main_1_status, "WiFi: ON   Node: 01");
  lv_obj_set_style_text_color(ui->Main_1_status, lv_color_hex(0x94A3B8),
                              LV_PART_MAIN);
  lv_obj_set_style_text_font(ui->Main_1_status, gui_assets_get_font_12(),
                             LV_PART_MAIN);
  lv_obj_align(ui->Main_1_status, LV_ALIGN_RIGHT_MID, -8, 0);

  ui->Main_1_cont_grid = lv_obj_create(ui->Main_1);
  lv_obj_set_size(ui->Main_1_cont_grid, 300, 170);
  lv_obj_align(ui->Main_1_cont_grid, LV_ALIGN_CENTER, 0, 5);
  ...
  static int32_t col_dsc[] = {92, 92, 92, LV_GRID_TEMPLATE_LAST};
  static int32_t row_dsc[] = {80, 80, LV_GRID_TEMPLATE_LAST};
  lv_obj_set_grid_dsc_array(ui->Main_1_cont_grid, col_dsc, row_dsc);

  create_tile(ui->Main_1_cont_grid, &ui->Main_1_tile_1, &ui->Main_1_img_1,
              &ui->Main_1_lbl_1, "Q:/gui/icon_01_rtmon_RGB565A8_100x100.bin",
              "实时监控", 0, 0);
  create_tile(ui->Main_1_cont_grid, &ui->Main_1_tile_2, &ui->Main_1_img_2,
              &ui->Main_1_lbl_2, "Q:/gui/icon_02_fault_RGB565A8_100x100.bin",
              "故障监测", 1, 0);
  create_tile(ui->Main_1_cont_grid, &ui->Main_1_tile_3, &ui->Main_1_img_3,
              &ui->Main_1_lbl_3, "Q:/gui/icon_03_analysis_RGB565A8_100x100.bin",
              "数据分析", 2, 0);
  create_tile(ui->Main_1_cont_grid, &ui->Main_1_tile_4, &ui->Main_1_img_4,
              &ui->Main_1_lbl_4, "Q:/gui/icon_04_history_RGB565A8_100x100.bin",
              "历史记录", 0, 1);
  create_tile(ui->Main_1_cont_grid, &ui->Main_1_tile_5, &ui->Main_1_img_5,
              &ui->Main_1_lbl_5, "Q:/gui/icon_05_log_RGB565A8_100x100.bin",
              "日志查看", 1, 1);
  create_tile(ui->Main_1_cont_grid, &ui->Main_1_tile_6, &ui->Main_1_img_6,
              &ui->Main_1_lbl_6, "Q:/gui/icon_06_alarm_RGB565A8_100x100.bin",
              "报警设置", 2, 1);

  ui->Main_1_footer = lv_obj_create(ui->Main_1);
  lv_obj_set_size(ui->Main_1_footer, 100, 20);
  lv_obj_align(ui->Main_1_footer, LV_ALIGN_BOTTOM_MID, 0, -4);
  ...
  lv_obj_set_flex_align(ui->Main_1_footer, LV_FLEX_ALIGN_CENTER,
                        LV_FLEX_ALIGN_CENTER, LV_FLEX_ALIGN_CENTER);
  lv_obj_set_style_pad_gap(ui->Main_1_footer, 8, LV_PART_MAIN);
  ...
  lv_obj_set_size(ui->Main_1_dot_1, 16, 6);
  lv_obj_set_style_bg_color(ui->Main_1_dot_1, lv_color_hex(0x38BDF8),
                            LV_PART_MAIN);
  lv_obj_set_style_radius(ui->Main_1_dot_1, 3, LV_PART_MAIN);
  lv_obj_set_style_border_width(ui->Main_1_dot_1, 0, LV_PART_MAIN);

  ui->Main_1_dot_2 = lv_obj_create(ui->Main_1_footer);
  lv_obj_set_size(ui->Main_1_dot_2, 6, 6);
  lv_obj_set_style_bg_color(ui->Main_1_dot_2, lv_color_hex(0xFFFFFF),
                            LV_PART_MAIN);
  lv_obj_set_style_bg_opa(ui->Main_1_dot_2, 50, LV_PART_MAIN);
  lv_obj_set_style_radius(ui->Main_1_dot_2, 3, LV_PART_MAIN);
  lv_obj_add_flag(ui->Main_1_dot_2, LV_OBJ_FLAG_CLICKABLE);

  ui->Main_1_dot_3 = lv_obj_create(ui->Main_1_footer);
  lv_obj_set_size(ui->Main_1_dot_3, 6, 6);
  lv_obj_set_style_bg_color(ui->Main_1_dot_3, lv_color_hex(0xFFFFFF),
                            LV_PART_MAIN);
  lv_obj_set_style_bg_opa(ui->Main_1_dot_3, 50, LV_PART_MAIN);
  lv_obj_set_style_radius(ui->Main_1_dot_3, 3, LV_PART_MAIN);
